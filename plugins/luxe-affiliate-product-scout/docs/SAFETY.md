...
- download, store, or republish Instagram video, audio, frames, or captions
- scrape Instagram profiles or stories

It may:

- repair and rescore one product every 5 minutes via WP-Cron
- take an hourly read-only snapshot of stored scores
- scan operator-pasted Instagram permalinks and Instagram URLs already stored on this site
- match those permalinks to the local WooCommerce catalog
- show original LuxeTrendsetters reel-studio copy for the operator to film
...
Keyword Intelligence remains the owner of ongoing Rank Math keyword/title/description optimization. Mission Control remains the evidence/audit owner. Luxe SEO Score Repair remains the public SEO green-signal owner.
