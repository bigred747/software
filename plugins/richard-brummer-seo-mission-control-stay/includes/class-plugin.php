...
class RBSMC_Stay_Plugin {
	...
	public function maybe_save_settings() {
		...
		add_settings_error( 'rbsmc_stay', 'saved', __( 'Stay Repair settings saved. Purge LiteSpeed cache once so public pages drop missing assets, pick up the guest-vary shield, and drop invalid JSON-LD.', 'rbsmc-stay' ), 'updated' );
	}
