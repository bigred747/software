 ...
 * Description: Safe public-output repair for LuxeTrendsetters. Fixes homepage titles, meta, Open Graph, truncated FAQ JSON-LD, bloated robots.txt, junk-page indexing, leaked shortcodes, and cache headers. Never writes post content, never changes post status, never rewrites Amazon URLs, never creates Rank Math redirects.
 * Version: 1.0.0
...
define( 'LUXE_SCORE_REPAIR_VERSION', '1.0.0' );
