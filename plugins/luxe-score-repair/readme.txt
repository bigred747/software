...
Luxe SEO Score Repair 1.4.2 is the public SEO plugin for luxetrendsetters.com. It lives in the left admin menu as **Luxe SEO**. Amazon AI lives here, not in Luxe Theme.
...
= 1.4.2 =
* Hostinger loopback that strips HSTS and Cache-Control stays yellow, not red
* SEO band stays 95-100-ready when only those header/blog probes are unverified
