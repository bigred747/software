...
24/7 process learning plus official Flatsome auto-update. Never downloads nulled zips.

== Description ==

Luxe Theme Guard 1.1.0 is the Flatsome auto-update plugin for luxetrendsetters.com. WordPress admin menu: **Luxe Theme**.

It:

* Runs 24/7 process learning: one signal every 5 minutes
